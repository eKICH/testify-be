...
public interface TestPlanService {
    ...
    void deleteTestPlan(Long id, Long userId);
    void addTestCaseToTestPlan(Long planId, Long caseId, Long userId);
    void removeTestCaseFromTestPlan(Long planId, Long caseId, Long userId);
